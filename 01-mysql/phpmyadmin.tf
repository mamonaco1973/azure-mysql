...
resource "azurerm_network_interface" "phpmyadmin-vm-nic" {
  name                = "phpmyadmin-vm-nic"                    # Name of the NIC resource in Azure
...
resource "azurerm_linux_virtual_machine" "phpmyadmin-vm" {
  name                = "phpmyadmin-vm"                        # Name of the VM shown in Azure Portal
  ...
  network_interface_ids = [
    azurerm_network_interface.phpmyadmin-vm-nic.id # Link the previously defined NIC
  ]
